                ...
                const hostOptions = {
                    ...
                    processWebWorker(workerFile, containingFile) {
                        ...
                        (result.warnings ??= []).push({
                            ...
                            notes: [
                                {
                                    text: `The worker entry point file '${workerFile}' found in '${path.relative(styleOptions.workspaceRoot, containingFile)}' will not be present in the output.`,
                                },
                            ],
                        });
